	...
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<div id="content">
				...
				<div id="board">
					<div id="list">
						<form action="${pageContext.request.contextPath}/tboard/list3" method="get"> <!-- form 주소 올바르게 기입했는지 확인 -->
						...
						<div id="paging">
							<ul>
								...
								<c:forEach begin="${pMap.startPageBtnNo}" end="${pMap.endPageBtnNo}" step="1" var="page"> <!-- step 각 반복에 대한 증가값(기본값 1) var 반복 변수에 대한 이름 정의. 반복 중 현재 항목 -->
									<c:choose>
